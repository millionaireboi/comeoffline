...
// Events are the homepage: paid traffic and cold visitors see real, bookable
// events immediately instead of scrolling through 7 brand sections to reach a
// dead-end list. The brand story lives below the feed for people who want it.
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="relative z-[1] mx-auto max-w-[430px] pb-15">
        {/* Feed header */}
        <section className="relative px-5 pt-20 pb-8">
          <div
      ...
      {/* Brand story — for cold visitors who scrolled past the events and
          want to know what this is before committing */}
